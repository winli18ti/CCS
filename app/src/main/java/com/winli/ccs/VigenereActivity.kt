...
import com.winli.ccs.databinding.ActivityVigenereBinding
...
class VigenereActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(view)
        supportActionBar?.title = "Vigenere Cipher"
        ...
        with(binding) {
            btnEncrypt.setOnClickListener {
                ...
                if (isEmpty(input, key)) {
                    ...
                    val output = Vigenere.encrypt(input, key)
            ...
            btnDecrypt.setOnClickListener {
                ...
                if (isEmpty(input, key)) {
                    ...
                    val output = Vigenere.decrypt(input, key)
                    etOutput.setText(output)
                }
            }
