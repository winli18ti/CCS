...
import com.winli.ccs.algorithm.ColumnarTransposition
import com.winli.ccs.databinding.ActivityCaesarBinding
import com.winli.ccs.databinding.ActivityColumnarTranspositionBinding

class ColumnarTranspositionActivity : AppCompatActivity() {
    private lateinit var binding: ActivityColumnarTranspositionBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityColumnarTranspositionBinding.inflate(layoutInflater)
        val view = binding.root
        setContentView(view)
        supportActionBar?.title = "Columnar Transposition Cipher"
        ...
        with(binding) {
            btnEncrypt.setOnClickListener {
                ...
                if (isEmpty(input, key)) {
                    ...
                    val output = ColumnarTransposition.encrypt(input, key)
            ...
            btnDecrypt.setOnClickListener {
                ...
                if (isEmpty(input, key)) {
                    ...
                    val output = ColumnarTransposition.decrypt(input, key)
                    etOutput.setText(output)
                }
            }
